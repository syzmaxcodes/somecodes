    ...
    <div id="pic_list_2" class="scroll_horizontal">
        ...
        <div class="box pro_commit">
            ...
            <div class="lbBox writeRiviewTitle">
                ...
                <p class="buttons-row">
                    <a external href="<?=  Yii::$service->url->getUrl('catalog/reviewproduct/add',['spu'=>$parentThis['spu'],'_id'=>$parentThis['oid']]); ?>" class="button button-round">
                        <?= Yii::$service->page->translate->__('Add Review'); ?>
                    </a>
                    <a external href="<?= Yii::$service->url->getUrl('catalog/reviewproduct/lists',['spu'=>$goods['spu'],'_id'=>$goods['oid']]); ?>" class="button button-round">
                        <?= Yii::$service->page->translate->__('View  All Review'); ?>(<?= $goods['review_count']; ?>)
                    </a>
                </p>
            </div>
