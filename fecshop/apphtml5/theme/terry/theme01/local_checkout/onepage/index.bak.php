            ...
            <div style="margin: 0;" class="group-select">
                ...
                <div class="onestepcheckout-threecolumns checkoutcontainer onestepcheckout-skin-generic onestepcheckout-enterprise">
                    ...
                    <div class="onestepcheckout-column-middle">
                        <div class="coupon_method_html">
                            <?php # 分享卡卷部分
                            $shippingView = [
                                'view'	=> 'local_checkout/onepage/index/local_coupon.php'
                            ];
                            $shippingParam = [
                        ...
                        <div class="shipping_method_html">
                            <?php # shipping部分
                            $shippingView = [
                                'view'	=> 'local_checkout/onepage/index/shipping.php'
                            ];
                            $shippingParam = [
                                'shippings' => $shippings,
                            ];
                        ...
                        <?php # payment部分
                        $paymentView = [
                            'view'	=> 'local_checkout/onepage/index/payment.php'
                        ];
                        $paymentParam = [
                            'payments' => $payments,
                            'current_payment_mothod' => $current_payment_mothod,
                    ...
                    <div class="onestepcheckout-column-right">
                        <div class="review_order_view">
                            <?php # review order部分
                            $reviewOrderView = [
                                'view'	=> 'local_checkout/onepage/index/review_order.php'
                            ];
                            $reviewOrderParam = [
                                'cart_info' => $cart_info,
...
<script>
    ...
    $("input[name = 'local_coupon_method']").click(function () {
        var val = this.value;
            ajaxurl = "<?= Yii::$service->url->getUrl('local_checkout/onepage/change_local_coupon'); ?>";
        $.ajax({
            url : ajaxurl,
            data : {val : val},
            dataType : 'json',
